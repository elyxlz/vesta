...
and the PR process, plus the Karpathy Guidelines that govern *how* to make changes. For how
the system is built and the design principles that govern it, see **[`CLAUDE.md`](./CLAUDE.md)**
