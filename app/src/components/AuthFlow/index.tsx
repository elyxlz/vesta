    ...
    if (authState === "submitting") {
      return (
        <div className="flex min-w-0 w-full max-w-full flex-col items-center gap-3">
          <h2 className="text-base font-semibold">verifying code...</h2>
      ...
      <div className="flex min-w-0 w-full max-w-full flex-col items-center gap-3">
        ...
        {onCancel && (
          <Button
            variant="link"
            onClick={onCancel}
            className="self-center h-auto px-0 py-0 text-xs font-normal text-muted-foreground hover:bg-transparent hover:text-foreground"
          >
            cancel
          </Button>
        )}
