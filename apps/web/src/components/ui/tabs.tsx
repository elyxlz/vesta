  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-card data-active:text-foreground data-active:shadow-sm data-active:ring-1 data-active:ring-foreground/5 dark:data-active:text-foreground dark:data-active:ring-foreground/10",
