...
// handshake raised "gateway_behind"). Drifting behind the gateway is fine (the protocol floor
// handles it); running ahead is not, so the app blocks until the gateway catches up. Unlike
// IncompatibleScreen this needs no app restart: the "update gateway" button asks vestad to
