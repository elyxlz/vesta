...
/// OpenRouter-only model switcher. Reuses the stored key (model-only update),
/// so changing the model needs no key re-entry. Hidden for Claude agents, whose
/// model is fixed at create time.
