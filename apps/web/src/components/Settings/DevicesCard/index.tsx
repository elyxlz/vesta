...
// desktop app) read a geolocation fix, which the OS prompts for; off reports only the timezone and
// retracts the position the gateway stored for this device, so changing your mind wipes it.
