...
import {
  controllerGateAction,
  type GateAction,
  type GateInput,
} from "./controller-gate";
...
const cases: {
  ...
  {
    name: "connected+foreground from nothing builds",
    prev: off,
    next: live,
    action: "build",
  },
  {
    name: "connecting while already foreground builds",
    prev: orphan,
    next: live,
    action: "build",
  },
  ...
  {
    name: "returning to foreground builds",
    prev: bg,
    next: live,
    action: "build",
  },
  {
    name: "disconnect while foreground closes",
    prev: live,
    next: orphan,
    action: "close",
  },
  ...
  {
    name: "background then disconnect is idle",
    prev: bg,
    next: off,
    action: "idle",
  },
  {
    name: "foreground while disconnected is idle",
    prev: off,
    next: orphan,
    action: "idle",
  },
