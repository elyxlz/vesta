...
contributor workflow — build/test commands, per-language code conventions, CI, and the PR
process — lives in **[`CONTRIBUTING.md`](./CONTRIBUTING.md)**, which is the authoritative
standards doc for both humans and agents. Read it before writing or shipping code.
...
The Karpathy Guidelines and Architecture Principles below govern *how* to apply those standards.
