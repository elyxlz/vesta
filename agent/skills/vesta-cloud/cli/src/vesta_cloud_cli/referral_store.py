...
The vesta-cloud skill and the onboard skill are separate Python packages (they can't
import each other), so this file is the contract between them: `vesta-cloud` is the
only place the code is ever SET (`vesta-cloud set-referral`); `onboard`
