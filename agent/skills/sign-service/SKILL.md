...
To keep the pad up across a container restart, read the `restart` skill and add this line to your restart daemons, marked TEMP because it comes back out at teardown:
```
