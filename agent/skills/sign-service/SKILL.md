...
To keep the pad up across a container restart, register this line for restart as `~/agent/skills/restart/SKILL.md` describes, marked TEMP because it comes back out at teardown:
```
