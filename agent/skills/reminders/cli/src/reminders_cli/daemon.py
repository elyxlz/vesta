"""Daemon lifecycle for the reminders CLI: the whole contract, owned here.
...
# The reminder list is the first thing the HTTP server can answer, so it doubles as the readiness probe.
READY_URL_PATH = "reminders"
...
# For this daemon that means no reminder fires at all until someone notices, which is the
