"""Daemon lifecycle for the flashcards CLI: the whole contract, owned here.
...
# The stats answer is the first thing the HTTP server can give, so it doubles as the readiness probe.
READY_URL_PATH = "stats"
