...
- **Persist it** by adding the serve command as a line in `~/agent/skills/restart/daemons.sh` (the daemon list the restart skill reads) if you want it always available.
