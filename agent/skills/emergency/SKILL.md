...
- **A facility's phone number from a search snippet or a directory is the LEAST reliable thing you
  ...
  hospital and the street were right and the phone number was DEAD: a stale third-party directory
  listing for a hospital that had since been renamed and renumbered. It cost nothing only because
  they took a taxi and never rang it. So give the number from the FACILITY'S OWN SITE or say you
  have not confirmed it, and remember the hierarchy: the emergency-services number is stable and
  public, an address is fairly stable, a facility's direct line goes stale silently. Never let a
  phone number be the only route you give.
