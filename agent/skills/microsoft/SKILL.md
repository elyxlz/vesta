...
- **An empty `email search` is not proof a message never arrived**: a message can sit in a folder the search does not surface, JunkEmail most of all. Confirm by listing that folder directly: `email list --folder junk`.
