...
# For this daemon that means the mic and the spoken reply are both gone, on a channel where
# the user gets silence rather than an error. Raising the ceiling costs a healthy start
# nothing: it returns the moment the port answers, in about a second.
