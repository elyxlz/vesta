...
So the watcher comes back after a container restart, register it for restart (see [skills-registry](../skills-registry/SKILL.md#registering-a-background-service)) with this startup command:
