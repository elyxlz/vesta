...
def format_notification_batch(notifications: list[Notification]) -> str:
    ...
    self-contained. ALL read-time guidance (reply command, group-chat note, personality hint)
    is producer-owned via the `reply_hint` attribute; core appends nothing."""
