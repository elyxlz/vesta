...
13. Have a real first conversation. Be genuinely curious about him as a person, not a setup target: what he is into, what he is building toward this season, what a good day looks like. Ask, listen, ask one more. Also ask how hard he wants to be pushed when something important is slipping (gentle nudge or relentless until it is done), and record that as a standing nudge mandate. Usefulness follows from understanding him, so understand him first. Then search the skill registry for adapt skills.
