...
def test_parse_sdk_message_extracts_thinking_blocks_and_ignores_tool_use():
    ...
    texts, thinking_blocks, session_id, _error_texts, _rate_limited = parse_sdk_message(msg)
...
def test_parse_sdk_message_returns_session_id_from_init():
    ...
    texts, _thinking_blocks, session_id, _error_texts, _rate_limited = parse_sdk_message(msg)
